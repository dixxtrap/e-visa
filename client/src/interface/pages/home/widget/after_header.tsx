...
export const AfterHeader = () => {
  ...
  return (
    <div className="w-[100dvw] flex relative">
      ...
      <div className="min-h-[0vh] py-10 flex flex-col  items-start justify-center sm:h-[40vh] md:h-[70vh] text-white bg-linear-30 from-40% from-black/70  to-black/0 text-center content-center w-full bg-transparent  z-[3]">
        <div className=" max-w-6xl flex flex-col items-start gap- mx-auto">
          <p className="sm:text-3xl md:text-5xl lg:text-7xl font-inter  text-left font-bold z-10">
            Obtenez votre visa électronique
            <br />
            pour le{" "}
            <span className="text-clip bg-linear-140 bg-clip-text italic text-transparent from-45% from-yellow-500 to-green-400">
              Pays de la téranga
            </span>
